...
Before starting this path, you should have completed the [Intermediate Learning Path](../intermediate/README.md) or have equivalent knowledge:
...
### 2. [Network Topology](network-topology/README.md)
**Duration**: 2.5 hours
...
### 3. [Node Operations](node-operations/README.md)
**Duration**: 3 hours
...
### 4. [Advanced Scripting](advanced-scripting/README.md)
**Duration**: 2.5 hours
...
### 5. [Custom Protocols](custom-protocols/README.md)
**Duration**: 3 hours
