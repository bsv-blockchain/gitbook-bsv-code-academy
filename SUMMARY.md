...
* [Welcome to BSV Code Academy](README.md)
...
* [@bsv/simple Overview](simple-sdk/README.md)
  * [Quick Start](simple-sdk/quick-start.md)
  * [Installation](simple-sdk/installation.md)
  * [Architecture](simple-sdk/architecture.md)
  * [Guides](simple-sdk/guides/browser-wallet.md)
    * [Browser Wallet](simple-sdk/guides/browser-wallet.md)
    * [Server Wallet](simple-sdk/guides/server-wallet.md)
    * [Payments](simple-sdk/guides/payments.md)
    * [Tokens](simple-sdk/guides/tokens.md)
    * [Inscriptions](simple-sdk/guides/inscriptions.md)
    * [MessageBox & P2P](simple-sdk/guides/messagebox.md)
    * [Certification](simple-sdk/guides/certification.md)
    * [DID (Decentralized Identity)](simple-sdk/guides/did.md)
    * [Verifiable Credentials](simple-sdk/guides/credentials.md)
    * [Overlay Networks](simple-sdk/guides/overlay.md)
    * [Next.js Integration](simple-sdk/guides/nextjs-integration.md)
  * [API Reference](simple-sdk/api-reference/wallet-core.md)
    * [WalletCore](simple-sdk/api-reference/wallet-core.md)
    * [BrowserWallet](simple-sdk/api-reference/browser-wallet.md)
    * [ServerWallet](simple-sdk/api-reference/server-wallet.md)
    * [Tokens Module](simple-sdk/api-reference/tokens.md)
    * [Inscriptions Module](simple-sdk/api-reference/inscriptions.md)
    * [MessageBox Module](simple-sdk/api-reference/messagebox.md)
    * [Certification Module](simple-sdk/api-reference/certification.md)
    * [DID Module](simple-sdk/api-reference/did.md)
    * [Credentials Module](simple-sdk/api-reference/credentials.md)
    * [Overlay Module](simple-sdk/api-reference/overlay.md)
    * [Types](simple-sdk/api-reference/types.md)
    * [Errors](simple-sdk/api-reference/errors.md)
  * [Gotchas & Pitfalls](simple-sdk/gotchas.md)
  * [MCP Server](simple-sdk/mcp-server.md)

## Code Features

* [Code Features Overview](code-features/README.md)
  ...
  * [Broadcast ARC](code-features/broadcast-arc/README.md)
  ...
  * [BRC-42 Derivation](code-features/brc-42-derivation/README.md)
  ...
  * [SPV Verification](code-features/spv-verification/README.md)
  * [SPV](code-features/spv/README.md)
